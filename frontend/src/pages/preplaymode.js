      ...
      <div className='poker-app--background'>
        ...
        <div className='game-action-bar' >
          ...
          <div className='slider-boi'>
            { (!this.state.loading)  && renderActionMenu(highBet, players, activePlayerIndex, phase, this.state.betInputValue ,this.handleBetInputChange)}
          </div>
